...
- Session-wise folders with code & exercises
- Demo projects built during live classes
- Recap sheets and homework
...
- A short README describing what we covered
...
**Session 2:** Your First Webpage (HTML + CSS)  
**Session 3:** Introduction to JavaScript  
**Session 4:** Events & Light/Dark Theme Toggle

### JavaScript Framework & Full-Stack Basics

**Session 5:** Building a Contact Form  
**Session 6:** Understanding APIs & Data Flow  
**Session 7:** Introduction to Node.js & Express  
**Session 8:** Connecting Frontend to Backend  
**Session 9:** Database Basics (MongoDB Atlas)  
**Session 10:** CRUD Operations (Read & Display Data)
...
- A fully deployed multi-page portfolio
- A working backend API connected to a database
- A live contact form with frontend + backend integration
- Their code hosted on GitHub
...
Free to use for educational and mentorship purposes.
